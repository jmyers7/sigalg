...
class ProbabilitySpace(SigmaAlgebraMethods, ProbabilityMeasureMethods):
    ...
    * Probability measure 'P':
    ...
    def from_event(
        ...
        >>> conditional_space = ProbabilitySpace.from_event(event=A)
    ...
    def sample_space(self) -> SampleSpace | None:
        ...
        * Probability measure 'P':
        ...
        Instantiate an empty `ProbabilitySpace` instance and set its sample space afterward. Notice the default sigma-algebra and probability measure that are created.
    ...
    def sig_alg(self) -> SigmaAlgebra | None:
        ...
        * Probability measure 'P|G':
        ...
        Instantiate an empty `ProbabilitySpace` instance and set its sigma-algebra afterward. Notice the default sample space and probability measure that are created.
    ...
    def prob_measure(self) -> ProbabilityMeasure | None:
        ...
        * Probability measure 'Q':
        ...
        Instantiate an empty `ProbabilitySpace` instance and set its probability measure afterward. Notice the default sample space and sigma-algebra that are created.
    ...
    def __lt__(self, other: ProbabilitySpace) -> bool:
    ...
    def __le__(self, other: ProbabilitySpace) -> bool:
    ...
    def __gt__(self, other: ProbabilitySpace) -> bool:
    ...
    def __ge__(self, other: ProbabilitySpace) -> bool:
