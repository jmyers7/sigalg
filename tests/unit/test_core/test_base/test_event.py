...
from sigalg.core import MeasurableSet, RandomVariable, SampleSpace, SigmaAlgebra
...
class TestConstructor:
    ...
    def test_from_list_union_of_two_atoms(self, Omega, F):
        ...
        B = MeasurableSet.from_list([0, 1, 2], sig_alg=F, name="B")
    ...
    def test_from_list_empty_set(self, Omega, F):
        ...
        empty = MeasurableSet.from_list([], sig_alg=F, name="empty")
    ...
    def test_from_list_all_sample_points(self, Omega, F):
        ...
        full = MeasurableSet.from_list([0, 1, 2, 3], sig_alg=F, name="full")
    ...
    def test_from_list_singleton(self, Omega, F):
        ...
        singleton = MeasurableSet.from_list([2], sig_alg=F, name="singleton")
    ...
    def test_indices_not_list_raises(self, F):
        ...
        with pytest.raises(TypeError, match="The indices must be a list"):
            MeasurableSet.from_list("not a list", sig_alg=F)
    ...
    def test_event_not_subset_of_sample_space_raises(self, F):
        ...
        with pytest.raises(ValueError, match="not a subset of the sample space"):
            MeasurableSet.from_list([5], sig_alg=F)
    ...
    def test_non_measurable_subset_raises(self, F):
        ...
        with pytest.raises(ValueError, match="The event is not measurable"):
            MeasurableSet.from_list([0, 2], sig_alg=F)
...
class TestGetItem:
    ...
    @pytest.fixture
    def A(self, F):
        return MeasurableSet.from_list([0, 1, 2], sig_alg=F)
    ...
    def test_getitem_slice_index(self, A):
        ...
        assert isinstance(result, MeasurableSet)
...
class TestSetTheoreticOperations:
    ...
    def test_complement_basic(self, Omega, F):
        """Test basic complement of an MeasurableSet."""
        indices = [0, 1]
        expected_complement = [2, 3]
        A = MeasurableSet.from_list(indices, sig_alg=F)
        comp = A.complement()

        assert isinstance(comp, MeasurableSet)
    ...
    def test_complement_using_tilde_basic(self, Omega, F):
        ...
        indices = [0, 1]
        expected_complement = [2, 3]
        B = MeasurableSet.from_list(indices, sig_alg=F, name="B")
        comp = ~B
    ...
    def test_double_complement(self, Omega, F):
        """Test that double complement returns the original MeasurableSet."""
        A = MeasurableSet.from_list([0, 1], sig_alg=F)
        double_comp = ~~A
    ...
    def test_union_disjoint(self, Omega, F):
        """Test union of disjoint MeasurableSets."""
        indices_a = [0, 1]
        indices_b = [2, 3]
        expected_union = [0, 1, 2, 3]
        A = MeasurableSet.from_list(indices_a, sig_alg=F, name="A")
        B = MeasurableSet.from_list(indices_b, sig_alg=F, name="B")
        union = A.union(B)
    ...
    def test_union_overlapping(self, Omega, F):
        """Test union of overlapping MeasurableSets."""
        indices_a = [0, 1]
        indices_b = [1, 2]
    ...
    def test_union_identical(self, Omega, F):
        """Test union of identical MeasurableSets."""
        indices_a = [0]
        indices_b = [0]
        expected_union = [0]
        A = MeasurableSet.from_list(indices_a, sig_alg=F, name="A")
    ...
    def test_union_using_pipe_disjoint(self, Omega, F):
        ...
        indices_b = [2, 3]
        expected_union = [0, 1, 2, 3]
        C = MeasurableSet.from_list(indices_a, sig_alg=F, name="C")
        D = MeasurableSet.from_list(indices_b, sig_alg=F, name="D")
        union = C | D
    ...
    def test_union_with_self(self, Omega, F):
        """Test union of an MeasurableSet with itself."""
        A = MeasurableSet.from_list([0, 1], sig_alg=F)
        union = A | A
    ...
    def test_intersection_overlapping(self, Omega, F):
        """Test intersection of overlapping MeasurableSets."""
        indices_a = [0, 1, 2]
        indices_b = [1, 2, 3]
    ...
    def test_intersection_disjoint(self, Omega, F):
        """Test intersection of disjoint MeasurableSets."""
        indices_a = [0, 1]
        indices_b = [2, 3]
    ...
    def test_intersection_identical(self, Omega, F):
        """Test intersection of identical MeasurableSets."""
        indices_a = [0, 1]
        indices_b = [0, 1]
    ...
    def test_intersection_using_ampersand_overlapping(self, Omega, F):
        ...
        E = MeasurableSet.from_list(indices_a, sig_alg=F, name="E")
        F = MeasurableSet.from_list(indices_b, sig_alg=F, name="F")
        intersection = E & F
    ...
    def test_intersection_with_self(self, Omega, F):
        """Test intersection of an MeasurableSet with itself."""
        A = MeasurableSet.from_list([0, 1], sig_alg=F)
        intersection = A & A
    ...
    def test_difference_basic(self, Omega, F):
        """Test basic difference of two MeasurableSets."""
        indices_a = [0, 1, 2]
        indices_b = [1, 2]
    ...
    def test_difference_disjoint(self, Omega, F):
        """Test difference of disjoint MeasurableSets."""
        indices_a = [0, 1]
        indices_b = [2, 3]
    ...
    def test_difference_identical(self, Omega, F):
        """Test difference of identical MeasurableSets."""
        indices_a = [0, 1]
        indices_b = [0, 1]
        expected_difference = []
        A = MeasurableSet.from_list(indices_a, sig_alg=F, name="A")
    ...
    def test_difference_using_minus_basic(self, Omega, F):
        ...
        indices_b = [2]
        expected_difference = [0, 1]
        G = MeasurableSet.from_list(indices_a, sig_alg=F, name="G")
        H = MeasurableSet.from_list(indices_b, sig_alg=F, name="H")
        difference = G - H
    ...
    def test_difference_with_self(self, Omega, F):
        """Test difference of an MeasurableSet with itself."""
        A = MeasurableSet.from_list([0, 1], sig_alg=F)
        difference = A - A
...
class TestSubsetSuperset:
    ...
    def test_subset_proper_subset(self, Omega, F):
        ...
        indices_a = [0, 1]
        indices_b = [0, 1, 2]
        A = MeasurableSet.from_list(indices_a, sig_alg=F)
        B = MeasurableSet.from_list(indices_b, sig_alg=F)
...
class TestEquality:
    def test_non_equality_different_indices(self):
        ...
        event1 = MeasurableSet.from_list([0, 1], sig_alg=SigmaAlgebra.power_set(Omega1))
        event2 = MeasurableSet.from_list([0, 2], sig_alg=SigmaAlgebra.power_set(Omega2))
    ...
    def test_non_equality_different_sample_spaces(self):
        ...
        event1 = MeasurableSet.from_list([0], sig_alg=SigmaAlgebra.power_set(Omega1))
        event2 = MeasurableSet.from_list(["a"], sig_alg=SigmaAlgebra.power_set(Omega2))
    ...
    def test_equality_different_names(self):
        ...
        Omega1 = SampleSpace().from_sequence(size=3)
        Omega2 = SampleSpace().from_sequence(size=3)
        event1 = MeasurableSet.from_list(
            [0, 1], sig_alg=SigmaAlgebra.power_set(Omega1), name="A"
        )
        event2 = MeasurableSet.from_list(
