...
class TestConstructor:
    ...
    def test_constructor_none_names(self, sample_space):
    ...
    def test_constructor_empty_indices(self, sample_space):
    ...
    def test_constructor_all_sample_points(self, sample_space):
    ...
    def test_constructor_single_index_custom_data(self, sample_space):
    ...
    def test_constructor_default_name(self, sample_space):
        """Test constructor with default name."""
        indices = ["omega_1", "omega_2"]
        data_name = "data_name"
        event = Event(sample_space=sample_space, data_name=data_name).from_list(indices)
        name = "A"
        expected_index = pd.Index(data=indices, name=data_name)
    ...
    def test_constructor_default_data_name(self, sample_space):
    ...
    def test_invalid_index_not_in_sample_space_raises(self, sample_space):
    ...
    def test_invalid_indices_not_list_raises(self, sample_space):
    ...
    def test_invalid_name_not_hashable_raises(self, sample_space):
    ...
    def test_invalid_data_name_not_hashable_raises(self, sample_space):
...
class TestGetEvent:
    ...
    def test_get_event_subset_indices(self, event):
    ...
    def test_get_event_single_index(self, event):
    ...
    def test_get_event_empty_indices(self, event):
    ...
    def test_get_event_all_indices(self, event):
    ...
    def test_invalid_index_not_in_sample_space_raises(self, event):
        """Test that index not in sample space raises exception."""
        indices = ["omega_0", "omega_5"]
...
class TestSetTheoreticOperations:
    ...
    def test_complement_of_empty(self, sample_space):
    ...
    def test_complement_of_full(self, sample_space):
    ...
    def test_complement_single(self, sample_space):
    ...
    def test_complement_using_tilde_basic(self, sample_space):
    ...
    def test_complement_using_tilde_single(self, sample_space):
    ...
    def test_double_complement(self, sample_space):
        ...
        A = Event(sample_space=sample_space).from_list(["omega_0", "omega_1"])
        double_comp = ~~A

        assert double_comp == A

    def test_union_disjoint(self, sample_space):
    ...
    def test_union_overlapping(self, sample_space):
    ...
    def test_union_identical(self, sample_space):
    ...
    def test_union_using_pipe_disjoint(self, sample_space):
    ...
    def test_union_using_pipe_overlapping(self, sample_space):
    ...
    def test_intersection_overlapping(self, sample_space):
    ...
    def test_intersection_identical(self, sample_space):
    ...
    def test_intersection_using_ampersand_overlapping(self, sample_space):
    ...
    def test_intersection_using_ampersand_disjoint(self, sample_space):
    ...
    def test_difference_identical(self, sample_space):
    ...
    def test_difference_using_minus_basic(self, sample_space):
    ...
    def test_difference_using_minus_disjoint(self, sample_space):
...
class TestSubsetSuperset:
    ...
    def test_subset_equal_subset(self, sample_space):
    ...
    def test_subset_not_subset(self, sample_space):
    ...
    def test_subset_empty_subset(self, sample_space):
    ...
    def test_subset_subset_of_full(self, sample_space):
    ...
    def test_superset_proper_superset(self, sample_space):
    ...
    def test_superset_equal_superset(self, sample_space):
    ...
    def test_superset_not_superset(self, sample_space):
    ...
    def test_superset_full_superset(self, sample_space):
    ...
    def test_superset_superset_of_empty(self, sample_space):
